...
<div class="wrapper">
  <div class="sidebar-slot">
    <div class="sidebar m3-container">
      ...
      <div class="icons">
        <Button as="a" type="text" iconType="full" href="https://github.com/sponsors/KTibow">
          <Icon icon={iconHeart} />
        </Button>
        <Button as="a" type="text" iconType="full" href="https://discord.gg/gS8T5RnMmA">
          <Icon icon={iconDiscord} />
        </Button>
        <Button as="a" type="text" iconType="full" href="https://github.com/KTibow/m3-svelte">
