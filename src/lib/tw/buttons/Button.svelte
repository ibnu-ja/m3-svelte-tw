    ...
    const buttonVariants = tv({
        ...
        variants: {
            ...
            color: {
                ...
                outlined: "bg-transparent text-on-surface-variant outline outline-1 -outline-offset-1 outline-outline-variant",
...
<style>
    ...
    .tw-btn.color-tonal:not(:disabled, :has(> :global(input:disabled))):has(> :global(input:checked)) {
